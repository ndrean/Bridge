...
//     // Add nats.zig as a local module (vendored g41797/nats, now Zig 0.15+ compatible)
//     // We import the root.zig directly instead of using b.dependency()
//     const nats_mod = b.addModule("nats", .{
//         .root_source_file = b.path("src/nats/src/root.zig"),
//         .target = target,
//         .optimize = optimize,
//     });
//     nats_mod.addImport("mailbox", mailbox.module("mailbox"));
//     nats_mod.addImport("zul", zul.module("zul"));
...
//     // REMOVED: nats.c is no longer needed
//     // All NATS operations now use pure Zig implementation (g41797/nats)
//     // KV operations were never activated, so nats.c can be completely removed
//     _ = nats_build_step; // Keep build function for reference but don't use it
